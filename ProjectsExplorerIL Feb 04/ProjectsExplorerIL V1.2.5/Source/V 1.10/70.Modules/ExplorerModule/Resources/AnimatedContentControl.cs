...
namespace ATSUI.CustomControls
{
        ...
        public class AnimatedContentControl : ContentControl
        {
            ...
            private void BeginAnimateContentReplacement()
            {
                ...
                m_paintArea.Visibility = System.Windows.Visibility.Visible;
                //
            ...
            private Brush CreateBrushFromVisual(Visual v)
            {
                ...
                var target = new RenderTargetBitmap(Convert.ToInt32((int)(this.ActualWidth)), Convert.ToInt32((int)(this.ActualHeight)), 96, 96, PixelFormats.Pbgra32);
                target.Render(v);
