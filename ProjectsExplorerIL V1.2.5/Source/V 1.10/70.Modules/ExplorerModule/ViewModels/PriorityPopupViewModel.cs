...
namespace ExplorerModule
{
    public class PriorityPopupViewModel : ViewModelBase
    {
        ...
        public PriorityPopupViewModel(string Parent, Type SourceItemType ,  IEnumerable<ContentModel> ActiveContents)
        {

            ParentId = Parent;
            this.SourceItemType = SourceItemType;
            ActiveContentsSeqList = ActiveContents.Select(l => l.seq).ToList();
