    ...
    public class ExportProjectToEnvBLL
    {
                                                                            ...
                                                                            ThreadStart t)
        {
            ...
            {                
                ...
                if (Status.messsageId != string.Empty && Status.messsageId != "241" && Status.messsageId != "242"
                    && Status.messsageId != "240" && Status.messsageId != "245") //Failed 
                {
                    FileSystemBLL.DeleteDirectoryRecursive(fsParentFolderFullPath);
                    return Status;
                }
                ...
                FileSystemBLL.DeleteDirectoryRecursive(fsParentFolderFullPath);
                if (Status.messsageId != "241" && Status.messsageId != "240") //Not only move or rename 
                {
