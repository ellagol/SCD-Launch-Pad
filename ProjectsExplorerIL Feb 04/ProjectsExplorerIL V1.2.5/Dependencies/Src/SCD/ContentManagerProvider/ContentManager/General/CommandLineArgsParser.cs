...
namespace ADTS
{
    ...
    /// support [–/]arg[:=]value; returns list of arguments per key 
    /// </summary>
    public class CommandLineArgsParser
    {
        ...
        private readonly Dictionary<string, StringCollection> _parameters;
        private string _waitingParameter;

        public CommandLineArgsParser(IEnumerable<string> arguments)
        {
            _parameters = new Dictionary<string, StringCollection>();
        ...
        public void Add(string argument, string value)
        {
            if (!_parameters.ContainsKey(argument))
                _parameters.Add(argument, new StringCollection());
        ...
        /// </summary>
        /// <value></value>
        public StringCollection this[string parameter]
        {
            get
            {
