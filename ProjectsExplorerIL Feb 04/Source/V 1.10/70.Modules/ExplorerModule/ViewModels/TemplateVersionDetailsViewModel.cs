	...
	public class TemplateVersionDetailsViewModel : ViewModelBase
	{
       ...
       public VersionModel GetVersionModel()
       {
        ...
        public TemplateVersionDetailsViewModel(Guid workspaceId, TreeViewNodeViewModelBase TV)
        {
            ...
            MessageMediator.Register(this.WorkspaceId + "OnTemplateVersionRapidExecutionVersionReceived", new Action<TreeViewTemplateVersionNodeViewModel>(OnTemplateVersionRapidExecutionReceived)); //Register to recieve a message asking for node refresh
            MessageMediator.Register(this.WorkspaceId + "OnTemplateVersionRapidExecutionVersionStartReceived", new Action<TreeViewTemplateVersionNodeViewModel>(OnTemplateVersionRapidExecutionVersionStartReceived)); //Register to recieve a message asking for node refresh
            MessageMediator.Register(this.WorkspaceId + "OnTemplateVersionProgressTextReceived", new Action<TreeViewTemplateVersionNodeViewModel>(OnTemplateVersionProgressTextReceived)); //Progress bar text     
            MessageMediator.Register(this.WorkspaceId + "OnClearTemplateVersionViewModelReceived", new Action<TreeViewTemplateVersionNodeViewModel>(OnClearTemplateVersionViewModelReceived)); //Register to recieve a message asking for node refresh
        ...
        private void OnTemplateVersionRapidExecutionReceived(TreeViewTemplateVersionNodeViewModel TV)
        {
        ...
        private void OnTemplateVersionRapidExecutionVersionStartReceived(TreeViewTemplateVersionNodeViewModel TV)
        {
            tabIndex = 0;
        ...
        private void OnTemplateVersionProgressTextReceived(TreeViewTemplateVersionNodeViewModel TV)
        {
        ...
        private void OnClearTemplateVersionViewModelReceived(TreeViewTemplateVersionNodeViewModel TP)
        {
            ClearViewModel();
        }
